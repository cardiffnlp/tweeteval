...
This README describes the format, file and directory structure associated with TweetEval, the benchmark associated to the Findings of EMNLP 2020 paper: "TweetEval: Unified Benchmark and Comparative Evaluation for Tweet Classification".
